                ...
                <div class="col-md-12">
                    <div class="square-widget">
                        <div class="widget-container">
                            ...
                            <form id="default" action="<?php echo U('Information/modify_information');?>"  enctype="multipart/form-data"  method="post" class="form-horizontal">
                                <fieldset title="————">
                                    <legend>资讯基本信息</legend>
                                    <div class="form-group">
                                        <label class="col-md-2 col-sm-2 control-label">标题</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" placeholder="标题" class="form-control" name="title" id="infotitle" value="<?php echo ($res["news_title"]); ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 col-sm-2 control-label">作者</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" placeholder="作者" class="form-control" name="author" value="<?php echo ($res["author"]); ?>" id="infoauthor">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <?php if(($num) > "0"): ?><div class="col-md-2 col-sm-2">
                                            <input type="text" placeholder="关键字"  class="form-control" name="key0" id="key0" value='<?php echo ($array[0]); ?>'>
                                        </div>
                                        <?php else: ?>
                                        ...
                                        <?php if(($num) > "1"): ?><div class="col-md-2 col-sm-2">
                                            <input type="text" placeholder="关键字" class="form-control" name="key1" id="key1" value='<?php echo ($array[1]); ?>'>
                                        </div>
                                        <?php else: ?>
                                        ...
                                        <?php if(($num) > "2"): ?><div class="col-md-2 col-sm-2">
                                            <input type="text" placeholder="关键字" class="form-control" name="key2" id="key2" value='<?php echo ($array[2]); ?>'>
                                        </div>
                                        <?php else: ?>
                                        <div class="col-md-2 col-sm-2" style="display:none;">
                                        ...
                                        <?php if(($num) > "3"): ?><div class="col-md-2 col-sm-2">
                                            <input type="text" placeholder="关键字" class="form-control" name="key3" id="key3" value='<?php echo ($array[3]); ?>'>
                                        </div>
                                        <?php else: ?>
                                        <div class="col-md-2 col-sm-2" style="display:none;">
                                ...
                                <fieldset title="———">
                                    ...
                                    <input type="file" id="input-file-now" name="img" class="dropify"  data-default-file="/thinkphp3.2.3/Public/information_img/<?php echo ($res["news_img"]); ?>"/>
                                    <input type='hidden' name='last_img' value='<?php echo ($res["news_img"]); ?>' />
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                    <textarea  rows="6" cols="50" name="summary"><?php echo ($res["news_summary"]); ?></textarea>
                                    </div>
                                    </div>
                                ...
                                <fieldset title="———">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="dropdown">
                                              <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="width:150px;"  val="{res.id}">
                                                <?php echo ($res["blockname"]); ?>
                                                <span class="caret"></span>
                                              </button>
                                              <input name="blockid" type="hidden" value="<?php echo ($res["id"]); ?>" id="hide"></input>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" placeholder="来源" name="source" id="infosource" class="form-control" value="<?php echo ($res["news_source"]); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <textarea name="content" id="Editorld"><?php echo ($res["news_content"]); ?></textarea>
                                        </div>
                                    </div>
