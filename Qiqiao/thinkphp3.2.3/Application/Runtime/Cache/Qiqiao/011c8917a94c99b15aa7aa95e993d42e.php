    ...
    <div class="main-content" >
        ...
        <table class="table table-hover text-center" style="margin:auto;width:1000px;">
            ...
            <?php if(is_array($message)): $i = 0; $__LIST__ = $message;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
            	...
            	<?php if($v['is_used']==1): ?><td>未读</td>
            	<?php else: ?>
            	<td>已读</td><?php endif; ?>
            	<td><div  class="tubox" val='<?php echo ($v["id"]); ?>' onclick="del('<?php echo ($v["id"]); ?>')"><img class="tu" src="/thinkphp3.2.3/Public/img/del_gray.png"><span>删除</span></div></td>
            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
        </table>

        <form action="<?php echo U('User/delmessage');?>" method="post" id="form">
