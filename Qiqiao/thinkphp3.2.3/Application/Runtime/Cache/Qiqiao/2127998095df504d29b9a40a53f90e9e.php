    ...
    <div class="main-content" >
        ...
        <div class="container" style="width:1000px;">
            ...
            <div class="col-xs-12 col-md-12 col-lg-6 form-inline pull-right" style="margin-top:50px;">
                <form class= style="padding:8px 0 " method='post' action="<?php echo U('Plan/add_type');?>">
                    <button type="submit" class="btn btn-primary pull-right" style="margin:5px 3px">新增</button>
                    <input type="text" class="form-control pull-right" name='name' style="margin:5px 3px" placeholder="请输入策划阶段" />
                </form>
            </div>
            </div>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form  id="app_form" action=<?php echo U('Plan/change_setting');?> method="post">

                            <?php if(is_array($block)): foreach($block as $key=>$v): ?><div class="form-group col-lg-3">
                                <input type="text" class="form-control" name="setting_<?php echo ($v["id"]); ?>" placeholder="填写类型" id="app" value="<?php echo ($v["name"]); ?>">
