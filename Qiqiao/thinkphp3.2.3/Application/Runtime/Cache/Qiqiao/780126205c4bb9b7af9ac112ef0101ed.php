...
<head>
  ...
  <link href="/317/thinkphp3.2.3/Public/css/style.css" rel="stylesheet">
  <link href="/317/thinkphp3.2.3/Public/css/style-responsive.css" rel="stylesheet">
  <link href="/317/thinkphp3.2.3/Public/css/jquery.stepy.css" rel="stylesheet">
  <link href="/317/thinkphp3.2.3/Public/js/iCheck/skins/flat/blue.css" rel="stylesheet">
...
<link rel="stylesheet" type="text/css" href="/317/thinkphp3.2.3/Public/ueditor/themes/default/css/ueditor.css">
...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <!--logo start-->
        <div class="logo">
            <a href="index.html"><img src="/317/thinkphp3.2.3/Public/img/logo.png" alt=""></a>
        </div>
        <!--logo end-->
        ...
        <div class="left-side-inner">
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                ...
                <ul class="nav nav-pills nav-stacked custom-nav">
                    ...
                    <li><a href="#"><i class="fa fa-sign-out"></i> <span>清除缓存</span></a></li>
                </ul>
            </div>
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-gear"></i> <span>系统</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li><a href="<?php echo U('Index/database','','');?>"> 备份数据库</a></li>
                        <li><a href="<?php echo U('Index/restore','','');?>"> 还原数据库</a></li>
                ...
                <li class="menu-list"><a href=""><i class="fa fa-video-camera"></i> <span>视频</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="<?php echo U('Video/attributes','','');?>"> 视频属性</a></li>
                        <li><a href="<?php echo U('Video/handle','','');?>">操作设置</a></li>
                        <li><a href="<?php echo U('Video/change','','');?>"> 视频转换</a></li>
                        <li><a href="<?php echo U('Video/pass','','');?>"> 视频审核</a></li>
                ...
                <div class="col-md-12">
                    <div class="square-widget">
                        <div class="widget-container">
                            ...
                            <form id="default" action="<?php echo U('Information/edit_information');?>"   method="post" class="form-horizontal">
                                <fieldset title="————">
                                    <legend>资讯基本信息</legend>
                                    <div class="form-group">
                                        <label class="col-md-2 col-sm-2 control-label">标题</label>
                                        <div class="col-md-6 col-sm-6">
                                            <input type="text" placeholder="标题" class="form-control" name="title" id="infotitle" value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-1 col-sm-1">
                                            <img src="/317/thinkphp3.2.3/Public/img/add.png" id="img" />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset title="———">
...
<script src="/317/thinkphp3.2.3/Public/js/jquery-2.1.4.min.js"></script>
<script src="/317/thinkphp3.2.3/Public/js/bootstrap.min.js"></script>
<script src="/317/thinkphp3.2.3/Public/js/modernizr.min.js"></script>


<script src="/317/thinkphp3.2.3/Public/js/jquery-ui-1.9.2.custom.min.js"></script>
<script src="/317/thinkphp3.2.3/Public/js/jquery-migrate-1.2.1.min.js"></script>
<script src="/317/thinkphp3.2.3/Public/js/jquery.nicescroll.js"></script>

<!--icheck -->
<script src="/317/thinkphp3.2.3/Public/js/iCheck/jquery.icheck.js"></script>
<script src="/317/thinkphp3.2.3/Public/js/icheck-init.js"></script>

<!--common scripts for all pages-->
<script src="/317/thinkphp3.2.3/Public/js/scripts.js"></script>


<script type="text/javascript" src="/317/thinkphp3.2.3/Public/js/jquery.stepy.js"></script>
<script type="text/javascript" src="/317/thinkphp3.2.3/Public/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="/317/thinkphp3.2.3/Public/ueditor/ueditor.all.js"></script>
<script type="text/javascript" charset="utf-8" src="/317/thinkphp3.2.3/Public/ueditor/lang/zh-cn/zh-cn.js"></script>



<script>
    $(function(){
        window.UEDITOR_HOME_URL='/317/thinkphp3.2.3/Public/ueditor/';
        window.onload=function(){
            window.UEDITOR_CONFIG.initialFrameWidth=800;  //初始化编辑器宽度,默认800
            window.UEDITOR_CONFIG.initialFrameHeight=500;

            var editor = new UE.ui.Editor({
                imageUrl:'/317/thinkphp3.2.3/Public/ueditor/uploadImage',
                fileUrl:'/317/thinkphp3.2.3/Public/ueditor/uploadFile',
                imagePath : '', 
                filePath : '', 
                imageManagerUrl:'/317/thinkphp3.2.3/Public/ueditor/imageManage', //图片在线管理的处理地址 
            });
