...
<link href="/thinkphp3.2.3/Public/Home/css/myCenter.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            ...
            <!--   我的项目  -->
            <div class="myproject col-lg-10 col-md-10 col-sm-9 col-xs-12">
                <div class="myproject-title">
                    <h3>我的项目</h3>
                </div>
                <div class="myproject-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($originalPro)): $i = 0; $__LIST__ = $originalPro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td><a href="<?php echo U('Variety/player',array('id'=>$vo['id']));?>">《<?php echo ($vo["video_title"]); ?>》</a></td>
                                    <td>作品</td>
                                    <td><?php echo (date("Y-m-d",$vo["vidup_time"])); ?></td>
                                    <?php if($vo["video_state"] == 0): ?><td>未审核</td>
                                    <?php elseif($vo["video_state"] == 1): ?><td style="color: rgba(45,186,233,1.0);">通过</td>
                                    <?php else: ?><td style="color: red">不通过</td><?php endif; ?>
                                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                <!-- 策划书显示 -->
                                <?php if(is_array($hatchPro)): $i = 0; $__LIST__ = $hatchPro;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <?php if($vo["plan_state"] == 1): ?><td style="color: rgba(45,186,233,1.0);">进行中</td>
                                    <?php else: ?><td style="color: red">搁置中</td><?php endif; ?>
                                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
                    </div>
